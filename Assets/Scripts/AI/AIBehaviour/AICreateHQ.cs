    ...
    public override void Execute()
    {
        ...
        else //Can not build at this place
        {
            foreach (GameObject unit in support.Builders) //try to find a new building site for the next frame
            {
                ...
                float Corner1PosX = CameraController.instance.Corner_01.position.x;
                float Corner2PosX = CameraController.instance.Corner_02.position.x;
                float Corner1PosZ = CameraController.instance.Corner_01.position.z;
                float Corner2PosZ = CameraController.instance.Corner_02.position.z;
